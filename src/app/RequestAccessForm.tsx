...
export function RequestAccessForm() {
  ...
  if (submitted) {
    return (
      <div className="card text-center py-8">
        ...
        <div className="text-sm font-semibold text-slate-900">Request submitted!</div>
  ...
  return (
    <form onSubmit={handleSubmit} className="card space-y-3">
      ...
      <label className="block">
        <div className="text-xs font-medium text-slate-600">Reason <span className="font-normal text-slate-400">(optional)</span></div>
        <textarea
          name="reason"
